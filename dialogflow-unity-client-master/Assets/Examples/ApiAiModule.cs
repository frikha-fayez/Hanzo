...
public class ApiAiModule : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        const string ACCESS_TOKEN = "17cc15426a644b32b7d514132d787e1e";
    ...
    public IEnumerator FinalScore(string text)
    {
        yield return new WaitForSeconds(0.5f);
        if(text.ToLower()=="excellent")
        {
            FindObjectOfType<SoundsManager>().Win();
        }
        else
        {
            FindObjectOfType<SoundsManager>().Lose();
        }
        yield return null;
    }
